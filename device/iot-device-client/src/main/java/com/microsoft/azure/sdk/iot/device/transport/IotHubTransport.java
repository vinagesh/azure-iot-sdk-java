...
public class IotHubTransport implements IotHubListener
{
    ...
    public void addMessage(Message message, IotHubEventCallback callback, Object callbackContext)
    {
        ...
        if (message instanceof BatchMessage && !(this.iotHubTransportConnection instanceof HttpsIotHubConnection || this.iotHubTransportConnection instanceof  AmqpsIotHubConnection))
        {
