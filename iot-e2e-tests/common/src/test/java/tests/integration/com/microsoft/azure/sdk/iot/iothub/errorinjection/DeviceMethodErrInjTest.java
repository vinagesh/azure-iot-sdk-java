...
public class DeviceMethodErrInjTest extends DeviceMethodCommon
{
    public DeviceMethodErrInjTest(IotHubClientProtocol protocol, AuthenticationType authenticationType, ClientType clientType, String publicKeyCert, String privateKey, String x509Thumbprint) throws Exception
    {
